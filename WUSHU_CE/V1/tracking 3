...
############################################################################
#
# --- SCRIPT DE TRACKING VIDÉO AVEC PERSPECTIVE ---
#
############################################################################
...
BASE_RADIUS_PX = 30
MAX_RADIUS_PX = 100  # Augmenté car l'ellipse aplatie parait plus petite
RING_HOLE_RATIO = 0.6 # Le trou noir fait 60% du rayon total (effet anneau)
...
def calculate_leg_angle(knee_pt, ankle_pt):
    """Calcule l'angle du vecteur tibia par rapport à l'horizontale."""
